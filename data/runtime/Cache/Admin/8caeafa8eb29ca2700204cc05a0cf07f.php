		...
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('User/edit_post');?>">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" readonly="readonly" name="user_login" value="<?php echo ($user_login); ?>">
					</div>
				</div>
				<div class="control-group">
				...
				<?php if($status != 0): ?><div class="control-group">
					<label class="control-label">分成比例</label>
					<div class="controls">
						<input type="text" name="income_percent" value="<?php echo ($income_percent); ?>">
					</div>
				</div><?php endif; ?>
