				...
				<div>
					<fieldset>
						<div class="control-group">
							...
							<div class="controls">		
                                <?php $type_0='0;普通房间'; $type_1='1;密码房间'; $type_2='2;门票房间'; $type_3='3;计时房间'; $type_6='6;私播房间'; ?>
								...
								<label class="checkbox inline"><input type="checkbox" value="6;私播房间" name="post[live_type][]" <?php if(in_array(($type_6), is_array($config['live_type'])?$config['live_type']:explode(',',$config['live_type']))): ?>checked="checked"<?php endif; ?>>私播房间</label>
