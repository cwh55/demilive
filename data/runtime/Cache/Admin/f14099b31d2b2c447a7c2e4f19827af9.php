			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					<?php if(is_array($roles)): foreach($roles as $key=>$vo): ?><tr>
						...
						<td>
							<?php if($vo['id'] == 1 or $vo['id'] == 5 or $vo['id'] == 6 ): ?><font color="#cccccc"><?php echo L('ROLE_SETTING');?></font>|<!-- <a href="javascript:open_iframe_dialog('<?php echo U('rbac/member',array('id'=>$vo['id']));?>','成员管理');">成员管理</a> | -->
