...
<meta charset="utf-8">
<title>哆咪直播 <?php echo L('ADMIN_CENTER');?></title>
...
<body style="min-width:900px;" screen_capture_injected="true">
 ...
 -->
	...
	<div class="main-container container-fluid">
		...
		<?php if($_SESSION['ADMIN_status'] == 0): ?><div class="main-content">
		...
		<?php if($_SESSION['ADMIN_status'] == 2): ?><div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<a id="task-pre" class="task-changebt">←</a>
					<div id="task-content">
					<ul class="macro-component-tab" id="task-content-inner">
						<li class="macro-component-tabitem noclose" app-id="0" app-url="<?php echo U('user/agent_total');?>" app-name="统计">
							<span class="macro-tabs-item-text"><?php echo L('HOME');?></span>
						</li>
					</ul>
					<div style="clear:both;"></div>
				...
				<div class="page-content" id="content">
					<iframe src="<?php echo U('user/agent_total');?>" style="width:100%;height: 100%;" frameborder="0" id="appiframe-0" class="appiframe"></iframe>
				</div>
			</div><?php endif; ?>

		<?php if($_SESSION['ADMIN_status'] == 1): ?><div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<a id="task-pre" class="task-changebt">←</a>
					<div id="task-content">
					<ul class="macro-component-tab" id="task-content-inner">
						<li class="macro-component-tabitem noclose" app-id="0" app-url="<?php echo U('user/channel_total');?>" app-name="统计">
							<span class="macro-tabs-item-text"><?php echo L('HOME');?></span>
						</li>
					</ul>
					<div style="clear:both;"></div>
				...
				<div class="page-content" id="content">
					<iframe src="<?php echo U('user/channel_total');?>" style="width:100%;height: 100%;" frameborder="0" id="appiframe-0" class="appiframe"></iframe>
				</div>
			</div><?php endif; ?>
